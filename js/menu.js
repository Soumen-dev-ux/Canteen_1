document.addEventListener("DOMContentLoaded", () => {
  ...
  const menuItems = [
    ...
    },
    {
      id: "25",
      name: "Maggie",
      description: "1 plate Maggie",
      price: 30,
      category: "Breakfast",
      image: "https://i.postimg.cc/QxjNtb1W/maggie-500x500.png",
      vegetarian: false,
    },
    {
      id: "26",
      name: "Egg Roll",
      description: "1 Egg Roll",
      price: 30,
      category: "Lunch",
      image: "https://i.postimg.cc/fbqS7P7F/Egg-roll-scaled.jpg",
      vegetarian: false,
    }
  ]
  ...
  if (passwordInput && showPasswordButton) {
    showPasswordButton.addEventListener("click", () => {
      ...
      showPasswordButton.textContent = type === "password" ? "Show Password" : "Hide Password";
    });
  }
})
